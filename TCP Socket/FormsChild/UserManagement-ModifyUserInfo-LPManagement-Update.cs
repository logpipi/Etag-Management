...
namespace TCP_Socket.FormsChild
{
    public partial class UserManagement_ModifyUserInfo_LPManagement_Update : Form
    {
        ...
        public void Setting(List<string> displayInfo)
        {
            ...
            comboBoxCarModel.Text = displayInfo[4];
            ...
            //}
            comboBoxGroup.Text = displayInfo[3];
            if (displayInfo[6].Equals("離席中"))
            {
                comboBoxIsParked.Text = "否";
            }
            else if (displayInfo[6].Equals("在位中"))
            {
                comboBoxIsParked.Text = "是";
            }
            //-----------------------
            string[] array = displayInfo[5].Split(' ');
            if (!displayInfo[5].Equals(""))
            {
                try
                {
                ...
                catch
                {
                    ...
                    textBoxP2.Text = "";
                    textBoxAddress.Text = "";
                    textBoxOther.Text = displayInfo[5];
                }
            }
            else
            {
